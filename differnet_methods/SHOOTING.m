...
v11 = 0.2;  %1st guess initial condition of ODE2
v12 = 0.1;  %2nd gyess initial condition of ODE2
y1 = 0.0;   %right bounday condition to be used for tolerance
tol = 0.0001;%TOLERANCE FOR ERROR
...
for i=1:imax+2
    ...
    Err = abs(y1-u(n));
    if (Err>=tol)
    fprintf("\nSolution was not obtained in %d iterations.",i);
    v11=v12;
    v12=vi;
    else 
    u(n)
